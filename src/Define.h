...
const QStringList C_exeptDir = { "/0_Build", "/0_build", "/1_archive", "/1_Archive" , "/Debug" , "/Release" , "/.git", "/.vscode", "/.cache" , "/.metadata" , "/Packages" };
const QStringList C_exeptFile = { ".txt.user", ".pro.user", "Thumbs.db", ".tcn.mp4", ".gitignore" };
